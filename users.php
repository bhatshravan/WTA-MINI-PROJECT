      ...
      <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-blue darken-3"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
            <li class="no-padding">
            ...
            <li class="bold active"><a href="users.php" class="waves-effect waves-blue darken-3"><i class="mdi-social-person"></i> Users</a>
            </li>
          </ul>
