      ...
      <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-blue darken-3"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
            <li class="no-padding">
              <ul class="collapsible collapsible-accordion">
                <li class="bold"><a class="collapsible-header waves-effect waves-blue darken-3 active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
            ...
            <li class="no-padding">
              <ul class="collapsible collapsible-accordion">
                <li class="bold"><a class="collapsible-header waves-effect waves-blue darken-3 active"><i class="mdi-action-question-answer"></i> Tickets</a>
                  <div class="collapsible-body">
                    <ul>
            ...
            <li class="bold"><a href="users.php" class="waves-effect waves-blue darken-3"><i class="mdi-social-person"></i> Users</a>
            </li>
            <!-- 
            <li class="bold">
              <a href="routers/logout.php"><i class="mdi-hardware-keyboard-tab"></i> Logout</a>
            </li> -->
          ...
          <div class="container">
            ...
            <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
              <div class="row">
                ...
                <div class="input-field col s12">
                  <button class="btn blue darken-3 waves-effect waves-light right" type="submit" name="action">Modify
            ...
            <form class="formValidate" id="formValidate1" method="post" action="routers/add-item.php" novalidate="novalidate">
              <div class="row">
                ...
                <div class="input-field col s12">
                  <button class="btn blue darken-3 waves-effect waves-light right" type="submit" name="action">Add
                    <i class="mdi-content-send right"></i>
                  </button>
                </div>
              </div>
