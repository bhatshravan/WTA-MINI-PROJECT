                ...
                while ($row1 = mysqli_fetch_array($sql1)) {
                  ...
                  echo '
								  <li class="collection-item avatar">
									  <i class="' . ($role1 == 'Administrator' ? 'mdi-action-star-rate' : 'mdi-social-person') . ' blue darken-3 circle"></i>
                  ...
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/ticket-message.php" novalidate="novalidate" class="col s12">					  
					  ...
					  <input type="hidden" name="ticket_id" value="' . $ticket_id . '">
                        ...
                        <div class="row">
                          <div class="input-field col s12">
                            <button class="btn blue darken-3 waves-effect waves-light right" type="submit" name="action">Reply
