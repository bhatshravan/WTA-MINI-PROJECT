...
(1, 2, '#19, Apartment 0 Jayanagar', 'I like food', '2017-03-28 17:32:41', 'Wallet', 150, 'Yet to be delivered', 0),
(2, 2, 'Kanakapura Rd, Raghuvanahalli, Bangalore City', '', '2017-03-28 17:43:05', 'Wallet', 130, 'Cancelled by Customer', 1),
(3, 3, '30th Main Rd, Banagirinagara, Banashankari Stage II', 'Sample Description 2', '2017-03-28 19:49:33', 'Cash On Delivery', 130, 'Yet to be delivered', 0),
(4, 3, '1st Cross Rd, near Jyoti Nivas College, KHB Colony', '', '2017-03-28 19:52:01', 'Cash On Delivery', 130, 'Cancelled by Customer', 1),
(5, 3, ' Near Cafe Coffee Day, 4th Block, Jayanagar', '', '2017-03-28 20:47:28', 'Wallet', 285, 'Paused', 0),
(6, 3, 'Outer Ring Rd, above Sony Centre, Kasavanahalli Village', '', '2017-03-30 00:43:31', 'Wallet', 325, 'Cancelled by Customer', 1);
...
(1, 1, 2, 'Problem with delivery', '2017-03-30 18:08:51'),
(2, 1, 2, 'It didnt arrive', '2017-03-30 19:59:09'),
(3, 1, 1, 'We wil have a look into it.', '2017-03-30 20:35:39'),
(4, 1, 1, 'We have refunded the amount.', '2017-03-30 20:49:35');
...
(1, 'Administrator', 'Shravan', 'root', 'toor', '', 'Address 1', 9429838929, 1, 0),
(2, 'Customer', 'Suhas', 'user1', 'pass1', 'abc@abc.com', 'Address 2', 9898012001, 1, 0),
(3, 'Customer', 'Rahul', 'user2', 'pass2', 'mail2@abc.com', 'Address 3', 889847492, 1, 0),
(4, 'Customer', 'Vikas', 'user3', 'pass3', '', '', 889847493, 0, 0),
(5, 'Customer', 'Ruthvik', 'user4', 'pass4', '', '', 9629838923, 0, 1);
...
(1, 1, '5155247490533921', 983, 3430),
(2, 2, '7087587142382050', 772, 1850),
(3, 3, '4595809639046830', 532, 1585),
(4, 4, '5475856443351234', 521, 2000),
(5, 5, '4776633115663264', 229, 2000);
